...
import {  Center, Heading ,ScrollView, VStack, Divider,FlatList, NativeBaseProvider } from "native-base";
...
const DishesScreen = () => <Text style={{ padding: 30, color: 'green' }}>Dishes Content goes here</Text>;

const HistoryScreen = () => <Text style={{ padding: 30, color: 'green' }}>History Content goes here</Text>;

const CartScreen = () => <Text style={{ padding: 30, color: 'green' }}>Cart Content goes here</Text>;
     ...
     <View style={styles.body}>
        <View style={styles.formContainer}>
            <View style={styles.headerContainer}>
              ...
              <Text style={{ color: 'rgb(237, 146, 29)', fontWeight: 800, fontSize: 35}}>Menu</Text>
            </View>
            <Text style={{ color : 'rgb(80, 93, 131)', textAlign: 'center', marginTop: 20, fontWeight: 600}}>Welcome ...</Text>

                        <Text style={{ color : 'rgb(80, 93, 131)', textAlign: 'center', marginTop: 20, fontWeight: 600}}>Please fill in information </Text>
            ...
            <View style={{ marginTop: 30 }}>
              ...
              <Button style={styles.signInButton} mode="contained" onPress={() => navigation.navigate('Login')}>
                  Proceed
              </Button>

            </View>

            <Text style={{ textAlign: 'center', color: 'gray', marginTop: 20 }}>Or</Text>
            <Text style={{ textAlign: 'center', color: 'gray', marginTop: 20 }}>If you have a PMG account</Text>

              <Button style={styles.signInButton} mode="contained" onPress={() => console.log('Pressed')}>
                  Sign In
              </Button>
            <View style={{ flexDirection: 'row' , borderColor: 'rgb(242, 242, 242)', marginTop: 20, borderWidth: 1,borderRadius: 3, paddingVertical: 15, paddingHorizontal: 8, marginHorizontal: 20}} >
                <Icon name="google" size={30} color="black" />
                <Text style={{ fontWeight: 500, color: 'rgb(179, 185, 203)', marginTop: 3, textAlign: 'center', marginHorizontal: 50 }}>Login with Google</Text>
            </View>

            <View style={{ flexDirection: 'row',marginTop: 30, borderColor: 'rgb(242, 242, 242)', borderWidth: 1,borderRadius: 3 , paddingVertical: 15, paddingHorizontal: 8, marginHorizontal: 20 }} >
                <Icon name="facebook" size={30} color="#0295E0" />
                <Text style={{ fontWeight: 500, color: 'rgb(179, 185, 203)', marginTop: 3 , textAlign: 'center', marginLeft: 50 }}>Login with facebook</Text>
            </View>
...
const LoginScreen = ({navigation}) => {
  ...
  const handleFormSubmit = async () => {
    await axios.post(`http://196.223.240.154:8099/supapp/api/auth/signin`, loginDetails)
      ...
      <View style={styles.body}>
        <View style={styles.formContainer}>
            <View style={styles.headerContainer}>
              ...
              <Text style={{ color: 'rgb(237, 146, 29)', fontWeight: 700, fontSize: 35}}>Menu</Text>
            </View>
            <Text style={{ color : 'rgb(80, 93, 131)', textAlign: 'center', marginTop: 20, fontWeight: 600}}>Welcome ...</Text>
            ...
            <View style={{ marginTop: 30 }}>
              ...
              <Button style={styles.signInButton} mode="contained" onPress={() => navigation.navigate('Dashboard')}>
                  Sign In
              </Button>
...
const WelcomeDashboard = () => {
  ...
  const [routes] = React.useState([
    ...
    { key: 'notification', title: 'Notification', icon: 'bell',color: 'white' },
...
const WelcomePage = () => {
    ...
    <View style={styles.container}>
     <View style={styles.container}>
        <Text style={{color: '#000', fontSize: 40,fontWeight:"800"}}>Supa</Text>
        <Text style={{color: '#fff', fontSize: 40,fontWeight:"800"}}>Menu</Text>
     </View>
...
const PaymentSuccessfull = ({navigation}) => {
    ...
    <View style={{ backgroundColor: 'black', minHeight: 900, paddingTop: 100 }}>
        ...
        <Text style={{ color: '#F7941C', textAlign: 'center', marginTop: 180 ,fontSize: 22, fontWeight: '600', marginRight: 20  }}>Payment Success, Yayy!</Text>


        <Text style={{ marginHorizontal: 50, marginTop: 40, textAlign: 'center', color: 'white', fontSize: 18, fontWeight: '500', marginRight: 20  }}>We will send your order details in contact no. and registered email</Text>

      <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 30 }}>
        <Text style={{ color: '#D07B52', fontSize: 18, fontWeight: '600', marginRight: 20  }}>Click Details</Text>
     ...
     <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 40}}>
        <Text style={{color: 'white', textlign: 'center', fontSize: 40,fontWeight:"600"}}>Supa</Text>
        <Text style={{color: '#F7941C', textlign: 'center', fontSize: 40,fontWeight:"600"}}>Menu</Text>
     </View>
      <StatusBar style="auto" />
    </View>
  );
